...
public enum GameFile
{
    ...
    RideBasculegionCollisionConfig,
    RideBasculegionConfig,
    RideChangeConfig,
    RideCommonConfig,
    RideSneaslerCollisionConfig,
    RideSneaslerConfig,
    RideSneaslerControllerConfig,
    RideWyrdeerCollisionConfig,
    RideWyrdeerConfig,
    RideUrsaringCollisionConfig,
    RideUrsaringConfig,
    RideUrsaringControllerConfig,
    RideBraviaryCollisionConfig,
    RideBraviaryConfig,
    RideBraviaryControllerConfig,
