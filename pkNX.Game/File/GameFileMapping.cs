...
public class GameFileMapping
{
    ...
    private static readonly GameFileReference[] FilesPLA =
    {
        ...
        new(RideBasculegionCollisionConfig , SingleFile, "bin", "misc", "app_config", "ride_basurao_collision_config.bin"),
        new(RideBasculegionConfig          , SingleFile, "bin", "misc", "app_config", "ride_basurao_config.bin"),
        ...
        new(RideSneaslerCollisionConfig    , SingleFile, "bin", "misc", "app_config", "ride_nyuura_collision_config.bin"),
        new(RideSneaslerConfig             , SingleFile, "bin", "misc", "app_config", "ride_nyuura_config.bin"),
        new(RideSneaslerControllerConfig   , SingleFile, "bin", "misc", "app_config", "ride_nyuura_controller_config.bin"),
        new(RideWyrdeerCollisionConfig     , SingleFile, "bin", "misc", "app_config", "ride_odoshishi_collision_config.bin"),
        new(RideWyrdeerConfig              , SingleFile, "bin", "misc", "app_config", "ride_odoshishi_config.bin"),
        new(RideUrsaringCollisionConfig    , SingleFile, "bin", "misc", "app_config", "ride_ringuma_collision_config.bin"),
        new(RideUrsaringConfig             , SingleFile, "bin", "misc", "app_config", "ride_ringuma_config.bin"),
        new(RideUrsaringControllerConfig   , SingleFile, "bin", "misc", "app_config", "ride_ringuma_controller_config.bin"),
        new(RideBraviaryCollisionConfig    , SingleFile, "bin", "misc", "app_config", "ride_whooguru_collision_config.bin"),
        new(RideBraviaryConfig             , SingleFile, "bin", "misc", "app_config", "ride_whooguru_config.bin"),
        new(RideBraviaryControllerConfig   , SingleFile, "bin", "misc", "app_config", "ride_whooguru_controller_config.bin"),
