...
public class GameFileMapping
{
    ...
    private static readonly GameFileReference[] FilesPLA =
    {
        ...
        new(RideBasculegionCollisionConfig     , SingleFile, "bin", "misc", "app_config", "ride_Basculegion_collision_config.bin"),
        new(RideBasculegionConfig              , SingleFile, "bin", "misc", "app_config", "ride_Basculegion_config.bin"),
        ...
        new(RideSneaslerCollisionConfig      , SingleFile, "bin", "misc", "app_config", "ride_Sneasler_collision_config.bin"),
        new(RideSneaslerConfig               , SingleFile, "bin", "misc", "app_config", "ride_Sneasler_config.bin"),
        new(RideSneaslerControllerConfig     , SingleFile, "bin", "misc", "app_config", "ride_Sneasler_controller_config.bin"),
        new(RideWyrdeerCollisionConfig   , SingleFile, "bin", "misc", "app_config", "ride_Wyrdeer_collision_config.bin"),
        new(RideWyrdeerConfig            , SingleFile, "bin", "misc", "app_config", "ride_Wyrdeer_config.bin"),
        new(RideUrsaringCollisionConfig     , SingleFile, "bin", "misc", "app_config", "ride_Ursaring_collision_config.bin"),
        new(RideUrsaringConfig              , SingleFile, "bin", "misc", "app_config", "ride_Ursaring_config.bin"),
        new(RideUrsaringControllerConfig    , SingleFile, "bin", "misc", "app_config", "ride_Ursaring_controller_config.bin"),
        new(RideBraviaryCollisionConfig    , SingleFile, "bin", "misc", "app_config", "ride_Braviary_collision_config.bin"),
        new(RideBraviaryConfig             , SingleFile, "bin", "misc", "app_config", "ride_Braviary_config.bin"),
        new(RideBraviaryControllerConfig   , SingleFile, "bin", "misc", "app_config", "ride_Braviary_controller_config.bin"),
