...
public class GameData8a
{
    ...
    public TableCache<EvolutionTable, Structures.FlatBuffers.Arceus.EvolutionSet> EvolutionData { get; init; } = null!;
    public TableCache<Structures.FlatBuffers.Arceus.Learnset, LearnsetMeta> LevelUpData { get; init; } = null!;
